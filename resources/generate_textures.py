...
path = '../src/main/resources/assets/beneath/textures/'
tfc_path = '../src/main/resources/assets/tfc/textures/'
mc_path = '../src/main/resources/assets/minecraft/textures/'
templates = 'texture_templates/'
...
def create_chest(wood: str):
    ...
    normal_left.save(tfc_path + 'entity/chest/normal_left/%s' % wood + '.png')
    ...
    left_trapped.save(tfc_path + 'entity/chest/trapped_left/%s' % wood + '.png')
    ...
    normal_right.save(tfc_path + 'entity/chest/normal_right/%s' % wood + '.png')
    ...
    right_trapped.save(tfc_path + 'entity/chest/trapped_right/%s' % wood + '.png')
