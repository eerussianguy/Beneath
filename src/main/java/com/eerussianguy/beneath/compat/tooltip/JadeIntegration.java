...
public class JadeIntegration implements IWailaPlugin
{
    ...
    {
        BeneathTooltips.BlockEntities.register((name, tooltip, block) -> register(registry, name, tooltip, block));
//        BeneathTooltips.Entities.register((name, tooltip, entity) -> register(registry, name, tooltip, entity));
    }
